...
Este proyecto se realizará individualmente y podrá intgrarse con el proyecto
[Burger Queen API client](link) de manera que puedas conocer la experiencia completa de desarrollo front/back.
